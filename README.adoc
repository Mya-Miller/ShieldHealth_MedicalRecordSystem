...
image:https://github.com/Mya-Miller/ShieldHealth_MedicalRecordSystem/blob/main/Information%20Architecture%20Diagram%20.png[
concept,650]
...
* Demo
+
image::https://github.com/Mya-Miller/ShieldHealth_MedicalRecordSystem/blob/main/DemoVideo.png[link=https://youtu.be/qLYc5d8SAsg]
